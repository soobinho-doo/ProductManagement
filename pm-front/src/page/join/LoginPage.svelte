...
<div class="mt-100">
    ...
    <!--  -->
        <div class="mt-20 display-flex align-items justify-content-between">
            <div class="display-grid align-items">
                ...
                <div class="padding-6">
                    <p class="fs-16 pretendard-regular color-b1">Product Admin Web</p>
                </div>
            </div>

            <div>
                <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="#b1b1b1">
    ...
    <div style="background-color: #2A3F54; padding: 16px 0px">
        <div class="layout-480">
            <div class="mt-30">
                <div class="mt-10">
                    <input type="text" class="fs-16 pretendard-regular padding-12-16 width-100 border-black border-radius-8 background-color-b1 inp-primary" bind:value={userId} bind:this={userIdElement} placeholder="아이디"/>
                </div>
            </div>
            
            <div class="mt-20">
                <div class="mt-10 position-relative">
                    <input type="password" class="fs-16 pretendard-regular padding-12-16 width-100 border-black border-radius-8 background-color-b1 inp-primary" bind:value={userPass} bind:this={userPassElement} placeholder="패스워드"/>
                    <button type="button" class="background-none border-none pass-icon" on:click={passChange}>
                        {#if isShowPass}
                            <svg xmlns="http://www.w3.org/2000/svg" class="svg-color-change" width="24" height="24" viewBox="0 0 576 512">
                        ...
                        {:else}
                            <svg xmlns="http://www.w3.org/2000/svg" class="svg-color-change" width="24" height="24" viewBox="0 0 640 512">
            ...
            <div class="mt-50">
                <button type="button" class="fs-16 pretendard-regular padding-12-16 width-100 border-black border-radius-8 background-none button-second" on:click={loginBtn}>로그인</button>
            </div>
            <div class="mt-10">
                <button type="button" class="fs-16 pretendard-regular padding-12-16 width-100 border-black border-radius-8 background-none button-second" on:click={() => {push("/register")}}>회원가입</button>
            </div>
            <div class="mt-20">
...
<style>
    .pass-icon {position: absolute; top: 8px; right: 12px;}
</style>
