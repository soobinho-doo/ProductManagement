        ...
        <div class="mt-20 padding-12 box-shadow-primary background-color-white">
            ...
            <div class="search-box gap-10">
                ...
                <div class="mt-10 display-flex align-items">
                    <input type="search" class="fs-16 pretendard-regular border-default inp-default padding-8-12 when-480" bind:value={keyword} on:input={()=>{cp = 1; getProductList()}} placeholder="상품 명 입력"/>
