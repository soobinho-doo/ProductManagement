    ...
    <div class="padding-12">
        ...
        <div class="mt-20 padding-12 box-shadow-primary background-color-white">
            ...
            <div class="mt-20">
                ...
                <div class="mt-10">
                    <input type="text" class="fs-1rem pretendard-regular mobile-width-100 min-width-250 border-default border-radius-4 padding-8-12" bind:value={productPrice} on:input={()=>{productPrice = onlyNumber(productPrice)}} maxlength="20" placeholder="상품 단가 입력(숫자만)"/>
                </div>
            </div>
