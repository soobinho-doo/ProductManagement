...
<div class="wrapper">
    ...
    <div class="padding-12">
        ...
        <div class="mt-10 padding-12 box-shadow-primary background-color-white">
            <p class="fs-20 pretendard-bold">메뉴</p>
        </div>
        ...
        <div class="mt-10 padding-12 box-shadow-primary background-color-white">
            ...
            <div>
                {#each menuDatas as datas}
                    <Accordion>
                        <div class="display-flex align-items gap-10 padding-12 border-bottom-b1" slot="acc-title">
                            ...
                            {:else if datas.menu_cd === "M002"}
                                <svg xmlns="http://www.w3.org/2000/svg" class="svg-color-change" width="24" height="24" viewBox="0 0 48 48">
                            ...
                            {/if}
                            <span class="fs-18 pretendard-bold">{datas.menu_nm}</span>
                        </div>
                        <div slot="acc-content">
                            {#each datas.subMenus as data}
                                <button type="button" class="display-flex align-items gap-5 padding-8-16 width-100 background-none border-none select-menu-bar" on:click={()=>{push(data.menu_srs)}}>
                                    ...
                                    <span class="fs-16 pretendard-regular">{data.menu_nm}</span>
                                </button>
                            {/each}
                        </div>
                    </Accordion>
